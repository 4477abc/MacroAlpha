...
Energy and Materials sectors' positive correlation with future CPI reflects their role in the inflation transmission mechanism. Energy price increases flow through to transportation costs, heating costs, and manufacturing inputs, eventually appearing in CPI with a lag. Materials price increases flow through to finished goods prices. These sectors' returns correlating more strongly with future CPI than current CPI suggests commodity price movements provide early signals of inflation trends, even if the signals are noisy. This finding supports research on yield curve predictors \cite{ang2009} and inflation forecasting, which document how asset prices can signal future macroeconomic conditions.
